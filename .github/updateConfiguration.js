...
product["applicationName"] = "codeoss";
...
product["urlProtocol"] = product["applicationName"];
...
product["extensionTips"] = {
  "ms-dotnettools.csharp":
    "{**/*.cs,**/project.json,**/global.json,**/*.csproj,**/*.cshtml,**/*.sln,**/appsettings.json}",
  ...
  "ms-vscode.PowerShell":
    "{**/*.ps1,**/*.psd1,**/*.psm1,**/*.ps.config,**/*.ps1.config}",
  ...
  "dbaeumer.jshint":
    "{**/*.js,**/*.jsx,**/*.es6,**/.babelrc,**/jsconfig.json,**/.jshintrc,**/.jshintignore}",
  ...
  "ms-azuretools.vscode-docker":
    "{**/dockerfile,**/Dockerfile,**/docker-compose.yml,**/docker-compose.*.yml,**/*.cs,**/project.json,**/global.json,**/*.csproj,**/*.cshtml,**/*.sln,**/appsettings.json,**/*.py,**/*.ipynb,**/*.js,**/*.ts,**/package.json}",
  "EditorConfig.EditorConfig": "{**/.editorconfig}",
  "HookyQR.beautify":
    "{**/.jsbeautifyrc,**/*.js,**/*.jsx,**/*.es6,**/.eslintrc.*,**/.babelrc,**/jsconfig.json}",
...
product["configBasedExtensionTips"] = {
  git: {
  ...
  "Microsoft Edge": {
    ...
    recommendations: {
      ...
      "ms-edgedevtools.vscode-edge-devtools": {
        name: "Elements for Microsoft Edge (Chromium)",
      },
    },
  },
  "Microsoft Edge Dev": {
...
//   "vs/workbench/workbench.desktop.main.js": "dPVDLhnIyzRAmHCuARctxA",
//   "vs/workbench/workbench.desktop.main.css": "QRTOyFyTWynvQHEmsJXT/Q",
//   "vs/workbench/services/extensions/node/extensionHostProcess.js":
//     "JplbWrWJ0tpWEsOmLgGbEQ",
//   "vs/code/electron-browser/workbench/workbench.html": "oUELX9mVAjhdP0ND63vLsA",
//   "vs/code/electron-browser/workbench/workbench.js": "eQmElY3k9Cp93g0BZegRsQ",
// };
// product["settingsSearchBuildId"] = 1590000879300;
// product["darwinUniversalAssetId"] = "darwin-universal";
